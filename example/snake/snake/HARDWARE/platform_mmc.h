...
//********************************************************************************
//V1.1????  20150731
//???SD_WriteDisk?SD_ReadDisk??if(CardType!=SDIO_STD_CAPACITY_SD_CARD_V1_1)???.
////////////////////////////////////////////////////////////////////////////////////////////////////  				
...
//?????			  
//SDIO??????:SDIO_CK??=SDIOCLK/[clkdiv+2];??,SDIOCLK???72Mhz
//??DMA?????,???????24Mhz,????????????,??????
//????????,????????,??SDIO_TRANSFER_CLK_DIV???3????
#define SDIO_INIT_CLK_DIV        0xB2 		//SDIO?????,??400Kh  
#define SDIO_TRANSFER_CLK_DIV    0x04		//SDIO????,??????????????? 
